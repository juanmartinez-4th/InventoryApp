...
@NamedQueries({
	@NamedQuery(name="findProductionByName", 
				query="from Production where lower(CODE) like :productionName OR "
						+ "lower(NAME) like :productionName OR "
						+ "lower(DESCRIPTION) like :productionName")
})
